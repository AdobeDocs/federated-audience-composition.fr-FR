...
| Disponibilité générale pour la région CHE2 (Suisse) |
| --- |
| Vous pouvez désormais configurer votre instance de composition d’audiences fédérées dans la région CHE2 (Suisse). |

### Améliorations {#fac-26-07-improvements}

---
audience: end-user
title: Présentation de Query Modeler
description: Découvrez comment utiliser le requêteur pour définir des règles afin de filtrer votre base de données.
...
# Présentation de Query Modeler {#query-modeler}

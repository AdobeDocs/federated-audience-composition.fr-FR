...
Si vous souhaitez utiliser la composition d’audiences fédérées sur un autre sandbox, contactez l’assistance clientèle d’Adobe pour demander un changement de sandbox.
